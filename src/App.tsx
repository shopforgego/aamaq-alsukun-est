...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-[#fdfaf5] text-stone-900 flex flex-col font-sans">
      <Header
        ...
        {filteredProducts.length === 0 ? (
          <div className="bg-black/5 border border-current/10 rounded-3xl p-12 text-center">
            ...
            <button
              ...
              className="bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold shadow-lg shadow-orange-600/25 text-xs px-4 py-2 rounded-xl"
            >
              إعادة تعيين البحث
            </button>
          </div>
